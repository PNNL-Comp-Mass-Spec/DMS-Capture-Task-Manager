    ...
    public class EasyHttp
    {
            ...
            NetworkCredential loginCredentials = null)
        {
            ...
            else
            {
                ...
                //TODO - remove this code NGT
                //TODO - this method should only allow Basic if the url starts with 'https'
                //c.Add(new Uri(url), "Negotiate", new NetworkCredential(loginCredentials.UserName,
                //    loginCredentials.SecurePassword, loginCredentials.Domain));
        ...
        private static byte[] CreatePropFindRequest(ArrayList properties)
        {
